        ...
        for i in range(len(self.percentage)):
            for j in range(len(self.time)):
                ...
                if len(self.trade_volumes_buy_sorted[j])>0:
                    ...
                    if np.std(self.trade_volumes_buy_sorted[j][pct_index:])>0:
                        volume_pct_buy_its = min(np.mean(self.trade_volumes_buy_sorted[j][pct_index:])\
                                             /np.std(self.trade_volumes_buy_sorted[j][pct_index:]),10)
                    else:
                ...
                if len(self.trade_volumes_sell_sorted[j])>0:
                    ...
                    if np.std(self.trade_volumes_sell_sorted[j][pct_index:])>0:
                        volume_pct_sell_its = min(np.mean(self.trade_volumes_sell_sorted[j][pct_index:])\
                                              /np.std(self.trade_volumes_sell_sorted[j][pct_index:]),10)
                    else:
                        volume_pct_sell_its = 10
