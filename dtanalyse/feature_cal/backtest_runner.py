...
from feature_manager import start_time, end_time
...
#deltas = catalog.order_book_deltas(["BTCUSDT.BINANCE"], start=start, end=end)
#print(deltas[:10])
...
#        account_type="MARGIN",
#        base_currency=None,
#        starting_balances=["0 BTC", "100000 USDT"],
...
strategies = [
    ImportableStrategyConfig(
        strategy_path="feature_manager:FeatureManager",
        config_path="feature_manager:FeatureManagerConfig",
        config=dict(
            instrument_id=instrument.id,
